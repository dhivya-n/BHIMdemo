        ...
        try{
            ...
            if (scanningResult != null) {
                ...
                try {
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, "https://techwhiz.cuff79.hasura-app.io/inventory/updatebarcode",body, new Response.Listener<JSONObject>() {
                        @Override
