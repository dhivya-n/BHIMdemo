               ...
               String rea=et.getText().toString();
                try {
                    ...
                    body.put("barcode",scanContent);
                      body.put("reason",rea);
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, "https://techwhiz.cuff79.hasura-app.io/discardrequest",body, new Response.Listener<JSONObject>() {
                        @Override
        ...
        try {
            ...
            if (scanningResult != null) {
                ...
                try {
                    ...
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, "https://techwhiz.cuff79.hasura-app.io/inventory/install/buyer",body, new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject response) {
                            // Toast.makeText(installActivity.this, response.toString(), Toast.LENGTH_SHORT).show();
                            try {
