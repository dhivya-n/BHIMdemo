    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (scanningResult != null) {
            ...
            try {
                ...
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, "https://techwhiz.cuff79.hasura-app.io/barcodedetails",body, new Response.Listener<JSONObject>() {
                    @Override
            ...
            ok.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        //  Toast.makeText(LoginActivity.this, body.toString(), Toast.LENGTH_SHORT).show();
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, "https://techwhiz.cuff79.hasura-app.io/service/requests",body, new Response.Listener<JSONObject>() {
                            @Override
                            public void onResponse(JSONObject response) {
                                Toast.makeText(disposeActivity.this, response.toString(), Toast.LENGTH_SHORT).show();
                                try{
